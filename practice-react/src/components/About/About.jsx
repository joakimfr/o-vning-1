...
function About() {
  const headline = 'Vem var Ada Lovelace?'
return (

  <div className ='about'>
  <h1 className = 'headline'>Vem var Ada Lovelace?</h1>
  <p className = 'text'>
  ...
  <h1 className = 'headline'>Uppväxt</h1>
  <p className = 'text'>
  ...
  <h1 className = 'headline'>Charles Babbage</h1>
  <p className = 'text'>
  ...
  <h1 className = 'headline'>Källor</h1>
  <p class='text'>
